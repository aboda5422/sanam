      ...
      <div className="container py-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 pb-8 border-b border-background/10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <a href="#" className="flex items-center gap-2 bg-background/10 hover:bg-background/20 rounded-lg px-3 py-2 transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <p className="text-[11px] text-background/40">
            © {new Date().getFullYear()} {BRAND.fullNameAr} | {BRAND.fullNameEn}
          </p>
        </div>
